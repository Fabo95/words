...
4. [Client-Side Data Fetching](#4-client-side-data-fetching) — **MEDIUM-HIGH**
   ...
   - 4.3 [Use React Query for Automatic Deduplication](#43-use-react-query-for-automatic-deduplication)
...
```tsx
// Module-level singleton to track callbacks and listener
...
This pattern ensures only one global keydown listener exists regardless of how many components use the hook.
